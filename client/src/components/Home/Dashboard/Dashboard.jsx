                ...
                <Grid container className={classes.Profile}>
                    ...
                    <Grid item className={classes.info}>
                        <Box className={classes.fieldContainer}>
                            ...
                            <Typography>{tempDetails.username}</Typography>
                        </Box>
                        <Box className={classes.fieldContainer}>
                            <Typography style={{ color: 'grey' }}>
                                Name
                            </Typography>
                            <Typography> {tempDetails.name} </Typography>
                        </Box>
                        <Box className={classes.fieldContainer}>
                            <Typography style={{ color: 'grey' }}>
                                About
            ...
            >
                ...
                {isEditable ? (
                    <TabPanel value={value} index={1}>
                        <Connections user={tempDetails} />
                    </TabPanel>
                ) : null}
                {isEditable ? (
                    <TabPanel value={value} index={2}>
                        <Pending user={tempDetails} />
                    </TabPanel>
                ) : null}
                {isEditable ? (
                    <TabPanel value={value} index={3}>
                        <Requests user={tempDetails} />
                    </TabPanel>
                ) : null}
            </Box>
            {/* RoadMap  */}
